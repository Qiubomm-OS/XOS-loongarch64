...
# GNU C11 (Ubuntu 9.4.0-1ubuntu1~20.04.1) version 9.4.0 (x86_64-linux-gnu)
...
# -auxbase-strip scripts/mod/devicetable-offsets.s -O2 -Werror -Wall
...
# -Werror=designated-init -Wno-packed-not-aligned -std=gnu11
# -fmacro-prefix-map=./= -fno-strict-aliasing -fno-common -fshort-wchar
# -fno-PIE -funsigned-char -fcf-protection=branch -falign-jumps=1
